...
public class Schedule implements Serializable {
    ...
    private DayOfWeek fk_day_of_week;
    ...
    private TimeOfPair fk_time_of_pair;
    ...
    public DayOfWeek getFk_day_of_week() {
        return fk_day_of_week;
    }
    public void setFk_day_of_week(DayOfWeek fk_day_of_week) {
    ...
    public TimeOfPair getFk_time_of_pair() {
        return fk_time_of_pair;
    }
    public void setFk_time_of_pair(TimeOfPair fk_time_of_pair) {
